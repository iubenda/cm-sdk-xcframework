...
- (id)                             init:(CmpConfig *)config withViewController:(UIViewController *)viewController autoupdate:(BOOL)autoupdate addOpenListener:(void (^)(
                                                                                                                                                                        void))openListener addCloseListener:(void (^)(void))closeListener addErrorListener:(void (^)(NSString *error))errorListener;
...
- (id)                             init:(CmpConfig *)config withViewController:(UIViewController *)viewController autoupdate:(BOOL)autoupdate addOpenListener:(void (^)(
                                                                                                                                                                        void))openListener addCloseListener:(void (^)(void))closeListener addOnCMPNotOpenedListener:(void (^)(void))onCMPNotOpenedListener addErrorListener:(void (^)(NSString *error))errorListener;

- (id)init:(CmpConfig *)config withViewController:(UIViewController *)viewController addErrorListener:(void (^)(NSString *error))errorListener;
...
- (void)errorListener:(void (^)(NSString *))errorListener;

- (void)rejectAll;

- (NSArray *)getPurposesList;

- (NSString *)getPurposes;
