...
+ (NSString *)getCmpLayerUrl:(NSString *)consent_string :(BOOL)force_open :(BOOL)rejectAll :(BOOL)acceptAll;

+ (NSString *)generateResponseUrlWithStamp:(NSInteger)stamp consentString:(NSString *)consent_string :(BOOL)force_open :(BOOL)rejectAll :(BOOL)acceptAll;
