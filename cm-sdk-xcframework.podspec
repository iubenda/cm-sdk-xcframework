...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "iubenda"
  # spec.authors            = { "iubenda" => "info@iubenda.com" }
  # spec.social_media_url   = "https://twitter.com/iubenda"
  ...
  #
  spec.source       = { :git => "git@github.com:iubenda/cm-sdk-ios.git", :tag => "#{spec.version}" }
